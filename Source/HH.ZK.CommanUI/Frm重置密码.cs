...
{
    public partial class Frm重置密码 : Form
    {
        public Frm重置密码()
        {
            InitializeComponent();
        ...
        private void Frm重置密码_Load(object sender, EventArgs e)
        {
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            var ret = CRMAPIClient.ResetPassword(txtMobile.Text, txt验证码.Text.Trim());
        ...
        private void btn获取验证码_Click(object sender, EventArgs e)
        {
            ...
            var ret = CRMAPIClient.SendMobileVerifyCode(txtMobile.Text);
        ...
        private void Frm重置密码_FormClosed(object sender, FormClosedEventArgs e)
        {
            timer1.Enabled = false;
        }
